define({ "api": [
  ...
  },
  {
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "Success-Response: ",
          "content": "{\n  \"code\": \"string\",\n  \"data\": [\n    {\n      \"createDate\": 0,\n      \"createMan\": \"string\",\n      \"id\": \"string\",\n      \"name\": \"string\",\n      \"updateDate\": 0,\n      \"updateMan\": \"string\",\n      \"validPeriod\": 0\n    }\n  ],\n  \"msg\": \"string\",\n  \"responseTime\": \"2019-02-15T07:39:26.615Z\",\n  \"status\": \"string\"\n}",
          "type": "json"
        }
      ]
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "description": "<p>分页查询字段名称 name 经销商/大客户名称 num 经销商/大客户编号 createMan 申请人</p>"
          },
          {
            "group": "Parameter",
            "type": "string",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "description": "<p>变更来源  SYSTEM_BILL(系統单据)MANUAL_ADJUST(手动调整) ORDER_PAY(订单回款) ORDER_BACK(订单退款)</p>"
          },
          {
            "group": "Parameter",
            "type": "string",
            "optional": false,
            "field": "query.changeType",
            "description": "<p>变更类型 ADD(增加) SUB(减少)</p>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "query.queryFieldName",
            "description": "<p>分页查询字段名称   name 经销商/大客户名称 num 经销商/大客户编号</p>"
          },
          {
            "group": "Parameter",
            "type": "string",
      ...
      "fields": {
        "错误码详情": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "20110014",
            "description": "<p>查询经销商营销中心关联表失败</p>"
          },
          {
            "group": "errorCode",
            "type": "string",
  ...
  {
    "type": "POST",
    "url": "/v1/xlink-order-rest/marketCenterUser/checkBigCustomerRelateInfo",
    "title": "校验哪些大客户已被关联",
    "name": "checkBigCustomerRelateInfo",
    "group": "MarketCenterUserManagerController",
    "description": "<p>校验哪些大客户已被关联</p>",
    "permission": [
      {
        "name": "userOnly"
      }
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "Success-Response: ",
          "content": "{\n  \"code\": \"string\",\n  \"data\": [\n    \"string\"\n  ],\n  \"msg\": \"string\",\n  \"responseTime\": \"2019-02-20T07:17:27.968Z\",\n  \"status\": \"string\"\n}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "POST",
    "url": "/v1/xlink-order-rest/marketCenterUser/cheackDealerRelateInfo",
    "title": "校验哪些经销商已被关联",
    "name": "checkDealerRelateInfo",
    "group": "MarketCenterUserManagerController",
    "description": "<p>校验哪些经销商已被关联</p>",
    "permission": [
      {
        "name": "userOnly"
      }
  ...
  {
    "type": "POST",
    "url": "/v1/xlink-order-rest/marketCenterUser/cheackPersonRelateInfo",
    "title": "校验哪些人员已被关联",
    "name": "checkPersonRelateInfo",
    "group": "MarketCenterUserManagerController",
    "description": "<p>校验哪些人员已被关联</p>",
    "permission": [
      {
        "name": "userOnly"
      }
  ...
  {
    "type": "POST",
    "url": "/v1/xlink-order-rest/marketCenterUser/listBigCustoms",
    "title": "查询大客户信息",
    "name": "listBigCustoms",
    "group": "MarketCenterUserManagerController",
    "description": "<p>查询大客户信息</p>",
    "permission": [
      {
        "name": "userOnly"
      }
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "query.queryFieldName",
            "description": "<p>customName/customCode</p>"
          },
          {
            "group": "Parameter",
            "type": "string",
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "Success-Response: ",
          "content": "{\n  \"code\": \"string\",\n  \"data\": {\n    \"count\": 0,\n    \"current_page\": 0,\n    \"list\": [\n      {\n        \"customCode\": \"string\",\n        \"customId\": \"string\",\n        \"customName\": \"string\",\n        \"marketCenterId\": \"string\",\n        \"marketCenterName\": \"string\"\n      }\n    ],\n    \"per_page\": 0\n  },\n  \"msg\": \"string\",\n  \"responseTime\": \"2019-03-21T06:30:09.283Z\",\n  \"status\": \"string\"\n}",
          "type": "json"
        }
      ]
    },
      ...
      "fields": {
        "错误码详情": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "20112005",
            "description": "<p>分页查询营销中心关联经销商失败</p>"
          },
          {
            "group": "errorCode",
            "type": "string",
  ...
  {
    "type": "POST",
    "url": "/v1/xlink-rent-rest/order/updateOrderInfo",
    "title": "修改直租物流单号",
    "name": "updateDirectRentOrderInfo",
    "group": "OrderRestController",
    "description": "<p>修改直租物流单号</p>",
    "permission": [
      {
        "name": "userOnly"
      }
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "Success-Response:",
          "content": "{\n \"code\": \"string\",\n \"data\": {\n   \"id\": \"string\",\n   \"logisticsBillId\": \"string\"\n },\n \"msg\": \"string\",\n \"responseTime\": \"2019-03-14T07:42:26.875Z\",\n \"status\": \"string\"\n}",
          "type": "json"
        }
      ]
    },
    "version": "0.0.0",
    "filename": "src/main/java/cn/xlink/cloud/order/rest/controller/OrderRestController.java",
    "groupTitle": "OrderRestController",
    "header": {
      "fields": {
        "Header": [
          {
